...
if __name__ == '__main__':
    ...
    for substance in substances:
        init_increases, init_reports, neighbors, relation, increase_count, a_value, b_value = load_data(substance)
        results = simulate(init_increases, init_reports, neighbors, relation, increase_count, a_value, b_value)
